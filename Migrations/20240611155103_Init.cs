        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    imageTaken = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    gardenowner = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gardens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Gardens_AspNetUsers_gardenowner",
                        column: x => x.gardenowner,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GardenAccess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GardenAccess_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GardenAccess_Gardens_GardenId",
                        column: x => x.GardenId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GardenAccess_GardenId",
                table: "GardenAccess",
                column: "GardenId");

            migrationBuilder.CreateIndex(
                name: "IX_GardenAccess_UserId",
                table: "GardenAccess",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Gardens_gardenowner",
                table: "Gardens",
                column: "gardenowner");
